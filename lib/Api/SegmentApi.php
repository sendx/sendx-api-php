...
class SegmentApi
{
     ...
     */
    public function segmentGet($api_key)
    {
        list($response) = $this->segmentGetWithHttpInfo($api_key);
        return $response;
    }

    /**
     * Operation segmentGetWithHttpInfo
     *
     * Get information about all segments
     *
     * @param string $api_key  (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function segmentGetWithHttpInfo($api_key)
    {
        // verify the required parameter 'api_key' is set
        if ($api_key === null) {
            throw new \InvalidArgumentException('Missing the required parameter $api_key when calling segmentGet');
        }
        // parse inputs
